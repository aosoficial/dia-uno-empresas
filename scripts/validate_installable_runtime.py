...
REQUIRED = [
    ...
    "docs/38_skill_evolution_v0.md", "docs/12_get_help_from_dia_uno.md", "docs/13_dia_uno_support_map.md",
    ...
    "templates/scorecards/digital-employee-performance-scorecard.md",
    ...
    "scripts/bootstrap_company_brain.py", "scripts/company_brain_wizard.py", "scripts/verify_installation.py", "scripts/validate_department_quality.py",
...
def main() -> int:
    ...
    for marker in ["--interactive", "department-rollout-map.md", "company-scorecard.md", "maturity-diagnosis.md", "--maturity", "--vertical", "COMPANY_TYPE_DEFAULTS"]:
    ...
    if errors:
        ...
        for error in errors:
            print(f"- {error}")
        return 1
    print("Installable accelerator validation OK; depth validation OK; skill template validation OK")
    return 0
